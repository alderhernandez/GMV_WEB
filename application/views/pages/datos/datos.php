...
<div class="contenedor">        
    <div class="noMargen row TextColor center"><div class="col s12 m8 l12 offset-m1">CARGA DE DATOS</div></div>
    		<div class="Buscar row column noMargen">
                <div class="input-field col s6 m4 l3 offset-s7 offset-m9 offset-l6">
	            	<button href="#MFile" class="modal-trigger BtnBlue btn waves-effect waves-light" type="submit" name="action">METAS CUOTAS
						<i class="material-icons left">cloud_upload</i>
					</button>
				</div>
                <div class="input-field col s6 m4 l3 offset-s7">
                    <button href="#RecFile" class="modal-trigger BtnBlue btn waves-effect waves-light" type="submit" name="action">RECUPERACIÓN
                        <i class="material-icons left">cloud_upload</i>
                    </button>
                </div>
            </div>            
...
<div id="MFile" class="modal">
    <div class="modal-content">
            ...
            <div class="row center">
                <span id="titulM" class="Mcolor">INGRESO DE DATOS (METAS Y CUOTAS)</span>
            </div>
...
<div id="RecFile" class="modal">
    <div class="modal-content">
            ...
            <div class="row center">
                <span id="titulM" class="Mcolor">INGRESO DE DATOS (RECUPERACIÓN)</span>
            </div>
        <form id="formExcel2" name="formExcel2" enctype="multipart/form-data" class="col s6 m6 l6" action="<?PHP echo base_url('index.php/subirdatos2');?>" method="post">
            <div class="row">
                <input type="hidden" value="0" id="tipo" name="tipo">
                <div class=" col s4 m4 l5">
                    <div class="file-field input-field">
                        <div class="redondo waves-effect waves-light btn btnArchivo BtnBlue">
                            <span>ARCHIVO EXCEL</span>
                            <input name='file' id="csv2" type="file">
                        </div>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text" placeholder"INGRESE EL ARCHIVO EXCEL">
                        </div>
                ...
                <div class="input-field col s4 m4 l3">
                    <input id="fecha2" name="fecha" type="date" class="datepicker">
                    <label for="fecha2">FECHA:</label>
                </div>
                <div class="switch input-field col s4 m4 l3">
                    <label>
                      NUEVO
                      <input id="swBandera" checked type="checkbox">
                      <span class="lever"></span>
                      ACTUALIZACIÓN
                    </label>
                </div>
            </div>
            <input id="bandera" name="bandera" value="0" type="hidden">
            <div class="row center">
            <a id="subirExcel2" class="redondo waves-effect waves-light btn">GUARDAR</a>
                <div id="loadsubir2" style="display:none" class="preloader-wrapper big active">
                    <div class="spinner-layer spinner-blue-only">
                        <div class="circle-clipper left"><div class="circle"></div></div>
                        <div class="gap-patch"><div class="circle"></div></div>
                        <div class="circle-clipper right"><div class="circle"></div></div>
